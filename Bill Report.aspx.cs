...
public partial class Bill_Report : System.Web.UI.Page
{
    ...
    {
        cmd = new SqlCommand("SELECT * FROM InvoiceView where orderno= " + TextBox1.Text + "", cn);
        cn.Open();
        cmd.ExecuteNonQuery();
        ...
        da.Fill(ds, "InvoiceView");

        ReportDocument doc = new ReportDocument();

        string path = Path.Combine(Request.PhysicalApplicationPath, "BillReport.rpt");
